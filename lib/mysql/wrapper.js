...
exports.createConnection = function createConnection(options) {
  ...
  var client = {
    ...
    connect: function() {
      this.realClient.connect.apply(this.realClient, arguments);
    },
    end: function(cb) {
...
exports.createPool = function createPool(options) {
  if (!options.createConnection) {
    options.createConnection = exports.createConnection;
  }
